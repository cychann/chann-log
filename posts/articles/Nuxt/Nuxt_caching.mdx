...
<img src="/posts/articles/Nuxt/Nuxt_caching/1.png" />
이미지 파일 Cache-Control
...
<img src="/posts/articles/Nuxt/Nuxt_caching/2.png" />
출처 : https://web.dev/articles/http-cache
...
<img src="/posts/articles/Nuxt/Nuxt_caching/3.png" />

Nuxt 3는 빌드 시마다 JavaScript와 CSS 파일의 이름에 해시값을 자동으로 추가합니다.

<img src="/posts/articles/Nuxt/Nuxt_caching/4.png" />
빌드할 때마다 파일 이름에 해시값 자동 생성
...
<img src="/posts/articles/Nuxt/Nuxt_caching/5.gif" />
getCachedData 미적용
...
<img src="/posts/articles/Nuxt/Nuxt_caching/6.gif" />
getCachedData 적용
